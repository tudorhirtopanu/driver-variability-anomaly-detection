"""Shared path loading for the standalone false-positive analysis scripts."""
...
def get_path(env_var: str, fallback_var: str | None = None, default: str | Path | None = None) -> Path:
    ...
    if fallback_var and fallback_var in _LOCAL_EXPORTS:
        return Path(_LOCAL_EXPORTS[fallback_var])
